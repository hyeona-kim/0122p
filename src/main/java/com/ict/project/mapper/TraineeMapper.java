...
public interface TraineeMapper {
    ...
    List<TraineeVO> course_searchValue(String c_idx, String select, String value, String year, String begin,
            String end);

    // ge
    List<TraineeVO> traineeReg(String begin, String end, String c_idx, String year, String ct_idx, String select,
            String value);
