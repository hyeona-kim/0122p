...
public class CounselReciptController {
    ...
    public ModelAndView counselReceiptMain(String listSelect) {
        ModelAndView mv = new ModelAndView();
        ...
        if (listSelect.equals("1")) {
            ...
            page.setTotalRecord(cd_Service.getSearchCount(null, null, null, null, null));
            page.setNowPage(1);

            mv.addObject("page", page);

            CounselingdetailVO[] cd_ad = cd_Service.searchCounseldetail(null, null, null,
                    String.valueOf(page.getBegin()), String.valueOf(page.getEnd()), null, null);
    ...
    public ModelAndView trainee(String chk1, String num, String cPage, String c_idx, String year, String ct_idx,
        ...
        TraineeVO[] ar = tn_Service.getTList(String.valueOf(page.getBegin()), String.valueOf(page.getEnd()), c_idx,
                year, ct_idx, select, value);
        if (ar != null) {
        ...
        if (t_file.getSize() > 0) {
            ...
            try {
                ...
                while (it.hasNext()) {
                    ...
                    if (vo.getTr_name() != null && vo.getTr_name().length() > 0 && vo.getTr_hp() != null
                            && vo.getTr_hp().length() > 0)
                        list.add(vo); // 리스트에 저장
                } // 행 반복의 끝
    ...
    public ModelAndView searchCounseldetail(String num, String year, String select, String value, String listSelect,
        ...
        ar = cd_Service.searchCounseldetail(select, value, year,
                String.valueOf(page.getBegin()), String.valueOf(page.getEnd()), c_idx, ct_idx);
