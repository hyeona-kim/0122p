        ...
        <ul class="navi">
            ...
            <li>
                ...
                <ul class="sub_manu">
                    ...
                    <li><a href="em_log?listSelect=4&cPage=1">&nbsp;&nbsp;&nbsp;능력단위 분석표</a></li>
                    <li><a href="em_log?listSelect=5&cPage=1">&nbsp;&nbsp;&nbsp;훈련생 개별 성적표</a></li>
                    <li><a href="em_log?listSelect=6&cPage=1">&nbsp;&nbsp;&nbsp;능력단위별 분석표</a></li>
                    <li><a href="em_log?listSelect=7&cPage=1">&nbsp;&nbsp;&nbsp;능력단위별 종합평가서</a></li>
                    <li><a href="em_log?listSelect=8&cPage=1">&nbsp;&nbsp;&nbsp;편차 비교표</a></li>
                    <li><a href="em_log?listSelect=9&cPage=1">&nbsp;&nbsp;&nbsp;평가결과분석</a></li>
                    <li><a href="em_log?listSelect=10&cPage=1">&nbsp;&nbsp;&nbsp;평가결과회의록</a></li>
                    <li><a href="em_log?listSelect=11&cPage=1">&nbsp;&nbsp;&nbsp;능력단위별평가지</a></li>
