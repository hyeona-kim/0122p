<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div>
	<form action="s_counselListAdd" method="post">
		<table id="tt_add2" class="add_l table">
			...
			<thead id="t2head">
                <input type="hidden" name="c_idx" value="${tvo.c_idx}"/>
                ...
                <input type="hidden" name="total"/>
                    <tr>
						<td colspan="4" align="center">
							<button type="button" onclick="total_add(this.form)" class="btn">등록</button>
							<button type="button" id="close" class="btn">취소</button>
						</td>
					</tr>
			</tbody>
		</table>
