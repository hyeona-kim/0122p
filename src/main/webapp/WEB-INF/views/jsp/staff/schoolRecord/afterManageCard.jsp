...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
    ...
    <form action="s_afterManage_axaj" method="post" name="qwe" encType="multipart/form-data">
        ...
        <tr>
            ...
            <c:if test="${wvo.file_name ne null}">
                <span style="font-size: 13px; color: red;">
                    <br/>기존파일:<a onclick="javascript:location.href='AfterManagedownFile?file_name=${wvo.file_name}'" style="font-size: 13px; color: red;">${wvo.file_name}</a></span>
            </c:if>
            </td>
        </tr>
    </table>
    <div class="main_item align_center">
        ...
        <input type="button" value="취소" class="btn" id="afterC_btn"/>
