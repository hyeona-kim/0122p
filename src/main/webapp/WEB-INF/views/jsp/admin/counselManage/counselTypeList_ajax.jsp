			...
			<caption>상담관리</caption>
							...
							<c:set var="num" value="${page.totalRecord - (page.numPerPage*(page.nowPage-1))}"/>
								<tr>
									...
									<td>
										<button type="button" onclick="javascript:location.href='counsel?listSelect=4&cPage=1&c_idx=${cvo.c_idx}'" class="btn">교육생별 상담내역</button>
										<button type="button" onclick="set2('${cvo.c_idx}')" class="btn">상담결과보고</button>
