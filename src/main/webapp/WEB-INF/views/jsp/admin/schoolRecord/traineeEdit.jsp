						...
						<thead>
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="3">
										<input type="text" name="tr_pos_code" id="sample6_postcode" placeholder="우편번호">
										<input type="button" onclick="checkPost()" value="우편번호 찾기"><br>
										<input type="text" name="tr_addr" id="sample6_address" placeholder="주소"><br>
										<input type="text" name="tr_addr" id="sample6_detailAddress" placeholder="상세주소">
										<input type="text" name="tr_addr" id="sample6_extraAddress" placeholder="참고항목">
									</td>
								<tr>
