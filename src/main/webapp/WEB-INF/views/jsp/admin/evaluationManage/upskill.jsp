...
<body>
        ...
        <article class="center">
            <div>
                ...
                <div class="right">
                    <div id="staffWrap">
                        <article>
                            <div id="staffList_top" class="title">능력단위 분석표</div>
	...
	$(function() {
        ...
        $.ajax({
			...
			type:"post",
			data:"listSelect=4&cPage=1&num="+numPerPage+"&select="+searchType+"&value="+searchValue+"&year="+selectYear,
	...
	function paging(str) {
		...
		$.ajax({
			url: "evalutationManageLog",
			type:"post",
			data:"listSelect=4&cPage="+cPage+"&num="+numPerPage+"&select="+searchType+"&value="+searchValue+"&year="+selectYear,
		}).done(function(result){
			$("#courseLog_Table").html(result);
		});
	}
