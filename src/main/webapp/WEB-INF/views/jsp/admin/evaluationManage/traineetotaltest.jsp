...
<body>
        ...
        <article class="center">
            <div>
                ...
                <div class="right">
                    <div id="staffWrap">
                        <article>
                            <div id="staffList_top" class="title">훈련생 종합 성적표</div>
	...
	$(function() {
        ...
        $.ajax({
			...
			type:"post",
			data:"listSelect=3&cPage=1&num="+numPerPage+"&select="+searchType+"&value="+searchValue+"&year="+selectYear,
	...
	function paging(str) {
		...
		$.ajax({
			url: "evalutationManageLog",
			type:"post",
			data:"listSelect=3&cPage="+cPage+"&num="+numPerPage+"&select="+searchType+"&value="+searchValue+"&year="+selectYear,
		}).done(function(result){
			$("#courseLog_Table").html(result);
		});
	}
