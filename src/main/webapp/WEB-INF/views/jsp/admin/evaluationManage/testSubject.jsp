...
<body>
        ...
        <article class="center">
            <div>
                ...
                <div class="right">
                    <div id="staffWrap">
                        <article>
                            <div id="staffList_top" class="title">과목별 채점결과</div>
	...
	$(function() {
        ...
        $.ajax({
			...
			type:"post",
			data:"listSelect=2&cPage=1&num="+numPerPage+"&select="+searchType+"&value="+searchValue+"&year="+selectYear,
	...
	function paging(str) {
		...
		$.ajax({
			url: "evalutationManageLog",
			type:"post",
			data:"listSelect=2&cPage="+cPage+"&num="+numPerPage+"&select="+searchType+"&value="+searchValue+"&year="+selectYear,
		}).done(function(result){
			$("#courseLog_Table").html(result);
		});
	}
