...
<body>
        ...
        <article class="center">
            <div>
                ...
                <div class="right">
                    <div id="staffWrap">
                        <article>
                            <div id="staffList_top" class="title">평가결과회의록</div>
	...
	$(function() {
        ...
        $.ajax({
			...
			type:"post",
			data:"listSelect=10&cPage=1&num="+numPerPage+"&select="+searchType+"&value="+searchValue+"&year="+selectYear,
	...
	function paging(str) {
		...
		$.ajax({
			url: "trainingLog",
			type:"post",
			data:"listSelect=10&cPage="+cPage+"&num="+numPerPage+"&select="+searchType+"&value="+searchValue+"&year="+selectYear,
		}).done(function(result){
			$("#courseLog_Table").html(result);
		});
	}
